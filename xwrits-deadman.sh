...
xwrits $activity_log_arg  typetime=40 breaktime=4 +mouse  +breakclock +finger=german  +beep +clock after 5 multiply maxhands=6 after 5 flashtime=:0.4 after 1 maxhands=2000 &
